...
const NewsLetermodel_1 = __importDefault(require("./NewsLetermodel"));
const sendNewsLetter = (mail, subject, title, news, image) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log(news);
        ...
        function main() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let info = yield transporter.sendMail({
                    ...
                    subject: `${subject}`,
                    text: `${news}`,
                    html: (0, NewsLetermodel_1.default)(news, image), // html body
                });
