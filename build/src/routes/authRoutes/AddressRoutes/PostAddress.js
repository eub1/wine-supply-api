...
const PostAddress_1 = __importDefault(require("../../../controllers/AddressController.ts/PostAddress"));
//* /address
...
router.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        ;
        if (req.body) {
            const changedAddress = yield (0, PostAddress_1.default)(user, req.body, req.query);
